...
G_MODULE_EXPORT void onOkBtnInsertDirectoryClicked(GtkButton *,  GtkDialog *);
G_MODULE_EXPORT void onOkBtnInsertCompanyClicked(GtkButton *,  GtkDialog *);
G_MODULE_EXPORT void onOkBtnInsertFamilyClicked(GtkButton *,  GtkDialog *);
G_MODULE_EXPORT void onOkBtnInsertArchClicked(GtkButton *,  GtkDialog *);
...
G_MODULE_EXPORT void onOkBtnUpdateDirectoryClicked(GtkButton *,  GtkDialog *);
G_MODULE_EXPORT void onOkBtnUpdateCompanyClicked(GtkButton *,  GtkDialog *);
G_MODULE_EXPORT void onOkBtnUpdateArchClicked(GtkButton *,  GtkDialog *);
G_MODULE_EXPORT void onOkBtnUpdateFamilyClicked(GtkButton *,  GtkDialog *);
